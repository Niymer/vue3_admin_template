...
export const reqRemoveUser=(usrId:number)=>request.delete<any,any>(API.REMOVEUSER_URL+usrId)

export const reqRemoveSelectUser=(idList:number[])=>request.delete(API.REMOVESELECTUSER_URL,{data:idList})
