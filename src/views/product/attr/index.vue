  ...
  <div>
    ...
    <el-card style="margin: 10px 0">
      ...
      <div v-show="scene == 1">
        ...
        <el-button type="primary" size="default" icon="Plus" :disabled="attrParams.attrName?false:true" @click="addAttrValue">
          添加属性值
        </el-button>
        ...
        <el-table border style="margin: 10px 0" :data="attrParams.attrValueList">
          ...
          <el-table-column label="属性值名称">
            <template #="{row,$index}">
              <el-input placeholder="请你输入属性值名称" v-model="row.valueName" v-if="row.flag" @blur="toLook(row,$index)" :ref="(vc:any)=>inputArr[$index]=vc"></el-input>
