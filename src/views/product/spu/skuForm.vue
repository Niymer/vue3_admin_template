...
<template>
  <el-form label-width="80px">
    ...
    <el-form-item label="重量(克)">
      <el-input placeholder="重量(克)"  v-model="skuParams.weight" type="number"></el-input>
    </el-form-item>
    ...
    <el-form-item label="平台属性">
      <el-form :inline="true">
        <el-form-item v-for="(item,index) of attrArr" :key="item.id" :label="item.attrName">
          <el-select v-model="item.attrIdAndValueId">
            <el-option v-for="(attrValue,index) of item.attrValueList" :key="attrValue.id" :label="attrValue.valueName" :value="`${item.id}:${attrValue.id}`"></el-option>
          </el-select>
        </el-form-item>
    ...
    <el-form-item label="销售属性">
      <el-form :inline="true">
        <el-form-item v-for="(item,index) of saleArr" :key="item.id" :label="item.saleAttrName">
          <el-select v-model="item.saleIdAndValueId">
            <el-option v-for="(saleAttrValue,index) of item.spuSaleAttrValueList" :key="saleAttrValue.id" :label="saleAttrValue.saleAttrValueName"
